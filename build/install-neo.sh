...
wget http://alpha.neohq.net/dist/neo4j-enterprise-3.0.0-M02-NIGHTLY-unix.tar.gz > null
mkdir neo
tar xzf neo4j-enterprise-3.0.0-M02-NIGHTLY-unix.tar.gz -C neo --strip-components=1 > null
